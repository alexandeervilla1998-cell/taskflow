        ...
        <div style={{ minHeight: "100vh", position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            >
                ...
                <div className="text-center mb-4 animate-fadeIn">
                    ...
                    >
                        <i className="bi bi-check2-square" style={{ fontSize: "1.6rem", color: "#388bfd" }}></i>
                    </div>
                    <h1 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#e2e8f0", margin: 0 }}>
                        Task<span style={{ color: "#388bfd", textShadow: "0 0 20px rgba(56,139,253,0.6)" }}>Flow</span>
                    </h1>
                ...
                <form onSubmit={handleSubmit} noValidate>
                        ...
                        <div style={{ position: "relative" }}>
                            <i
                                ...
                                style={{
                                    ...
                                    transform: "translateY(-50%)", color: focused === "correo" ? "#388bfd" : "#718096",
                    ...
                    <div className="mb-3 animate-slideLeft delay-2">
                        ...
                        <div style={{ position: "relative" }}>
                            <i
                                ...
                                style={{
                                    position: "absolute", left: "14px", top: "50%",
                                    transform: "translateY(-50%)", color: focused === "contrasena" ? "#388bfd" : "#718096",
                                    transition: "color 0.2s", zIndex: 1, fontSize: "0.9rem"
                                }}
                            ></i>
                            <input
                    ...
                    {/* Recordar */}
                    <div className="mb-4 animate-slideLeft delay-3" style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                        <input
                            type="checkbox"
                            name="recordar"
                            ...
                            id="recordarSesion"
                        />
                        <label htmlFor="recordarSesion" style={{ fontSize: "0.85rem", color: "#718096", cursor: "pointer" }}>
                            Recordar sesión
                        </label>
                    </div>
                ...
                <p style={{ textAlign: "center", fontSize: "0.85rem", color: "#718096", margin: 0 }}>
                    ¿No tienes cuenta?{" "}
                    <Link to="/register" style={{ color: "#388bfd", textDecoration: "none", fontWeight: 600 }}>
                        Regístrate
                    </Link>
                </p>
            </div>
